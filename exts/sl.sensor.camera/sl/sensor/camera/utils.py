...
_CAMERA_CONFIGS = {
    "ZED_2i": {"base_model": "ZED_2i", "is_4mm": False, "is_stereo": True, "pixel_size": 2},
    "ZED_2iM": {"base_model": "ZED_2i", "is_4mm": False, "is_stereo": True, "pixel_size": 2},
...
def get_resolution(camera_model: str, camera_resolution: str) -> Optional[List[int]]:
    ...
    elif camera_model in ["ZED_2i", "ZED_2iM"]:
